...
(() => {
  const messages = {
  "wolfawwent's Model Dungeon": "wolfawwent 的模型地城",
  "All Models — wolfawwent's Model Dungeon": "全部模型 — wolfawwent 的模型地城",
  ...
  "Hi, I'm": "嗨，我是",
  "— a pixel artist.": "—— 一位像素藝術創作者。",
  "He / Him · GMT+8": "他 · GMT+8",
  "I make random stuff.": "喜歡做各式各樣的東西。",
  "→ Items, Entities, VFX, Furniture, Animations": "→ 道具、生物、視覺特效、家具、動畫",
  "Hit me up on": "歡迎透過",
  "Drag or swipe a row to see more.": "左右拖曳或滑動卡片列，探索更多作品。",
  ...
  "Weapon cards": "武器卡片",
  "Item cards": "道具卡片",
  "Commissions, collabs, or just say hi.": "委託製作、合作邀約，或只是來打聲招呼，都歡迎。",
  "← BACK": "← 返回作品",
  "All Models": "全部模型",
  "All cards": "全部卡片",
  "pixel-art 3D models": "像素風格 3D 模型",
  "items · entities · vfx · furniture": "道具 · 生物 · 視覺特效 · 家具",
